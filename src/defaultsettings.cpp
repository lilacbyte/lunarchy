...
void set_default_settings()
{
	...
	settings->setDefault("crystalspam.target_radius", "20");
	settings->setDefault("crystalspam.safe", "false");
	settings->setDefault("crystalspam.3x3", "false");
	...
	settings->setDefault("no_slow_plus", "false");
	...
	settings->setDefault("tunnel_esp_min_length", "3");
	settings->setDefault("tunnel_esp_max_width", "3");
...
#undef USEKEY2
	...
	settings->setDefault("lag_optimizer.fast_chunks", "true");
	settings->setDefault("lag_optimizer.no_plant_animation", "true");
	...
	settings->setDefault("lag_optimizer.suppress_tiles", "true");
