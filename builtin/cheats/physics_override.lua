...
core.register_cheat("fastfall", "Movement", "fastfall")
core.register_cheat_setting("Fall Speed", "Movement", "fastfall", "fastfall.multiplier", {type="slider_float", min=1.0, max=8.0, steps=71})
